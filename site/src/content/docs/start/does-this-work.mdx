...
- **The two evals carry two dates, and are not blended.** The trigger eval was re-run **2026-09-10** (755 routing cases, on `claude-opus-5`); the output eval still reports the **2026-06-25** run (429 checks) and has not been re-run since. Both superseded the earlier split cohorts (56 core skills 2026-06-17, 7 contested lenses 2026-06-19).
