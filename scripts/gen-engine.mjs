...
// (skills/think-top3/references/engine.md). think-random-perspectives ships a byte-identical
...
const DST = resolve(ROOT, 'skills/think-random-perspectives/references/engine.md');
...
if (check) {
  ...
  if (cur !== src) {
    console.error('gen-engine: skills/think-random-perspectives/references/engine.md is stale - run `node scripts/gen-engine.mjs`.');
    process.exit(1);
  }
...
console.log('gen-engine: wrote skills/think-random-perspectives/references/engine.md');
