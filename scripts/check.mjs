...
//   5. the recipe-command drift check (scripts/gen-recipe-commands.mjs --check, SPEC-09 1b):
//      every commands/<recipe>.md is regenerated byte-identically from its _workflows/ source,
//      so a hand-edited recipe command cannot drift from the chain it claims to run, and
