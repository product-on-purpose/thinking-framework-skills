...
**Status:** **SHIPPED 2026-06-19 (v0.11.0).** All 7 contested lenses built, integrated, evaluated (trigger 100% / 0 false-fires; output 100%), and adversarially reviewed. Phase 1 (the contract + the SWOT/ACH exemplars) was de-risked and merged on its own PR (#83) before the batch; the remaining 5 + the cut followed. Membership was FINALIZED 2026-06-19 (a Phase 0 dry-run found the strict three-test gate self-contradictory; the admission rule was corrected and the set locked at **7 skills**).
