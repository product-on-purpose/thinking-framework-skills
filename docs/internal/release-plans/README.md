...
| [`plan_v0.10.0/`](./plan_v0.10.0/) | (unreleased) | **Planned** | Measure, then decide: the full-catalog (56-skill) eval re-run + trust-page refresh first (zero-regret), then read the live GA4 signal to choose between a content push and an acquisition push. Wave 0 content is deferred until a signal exists. Holds the ceiling-vs-regret rationale for the post-v0.9.0 work line. |
