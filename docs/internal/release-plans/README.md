...
| [`plan_v0.7.0/`](./plan_v0.7.0/) | (in flight) | **Planning** 2026-06-11 | Eval-informed quality pass + wave-3 candidate intake: tighten the four output-eval-flagged skills, vet the re-opened 30-cand queue (12th + 13th families, the dialectical-bootstrapping unbundle), build/document survivors, then cut. |
