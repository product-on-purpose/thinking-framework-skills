...
> **STATUS: SHIPPED v0.7.0 (2026-06-12).** Tagged, GitHub release published, marketplace re-pinned (agent-plugins #30), docs deploy verified on `48305c2`. Phase 0 (intake) merged as PR #56; phase 1 (four tightened skills) as PR #57; phase 2 (the 30-candidate NAME-mode vetting) complete - **9 Build, 7 Fold, 1 Recipe, 13 Reject**, reconciled in [`phase2-verdicts.md`](./phase2-verdicts.md); phase 3a (21 fold/reject/recipe reconciliations + 20 published dossiers + the IBIS recipe) + phase 4 (six enrichments, [`phase2-enrichments.md`](./phase2-enrichments.md)) merged (`d6e271a`); phase 3b (the 9 built survivors + the 12th skill-family Ethics & Values Deliberation, catalog 47 -> 56) merged as PR #58. The v0.7.0 cut (version bump, CHANGELOG/RELEASE-NOTES, tag, marketplace re-pin) follows [`release-process.md`](../../release-process.md). Canonical history stays in [`CHANGELOG.md`](../../../../CHANGELOG.md).
