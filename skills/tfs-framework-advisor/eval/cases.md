# Eval cases: tfs-framework-advisor
...
- "Run a premortem on our launch." (the user already knows the move - route directly to `tfs-premortem`, not the advisor)
- "Compare these three vendors against our weighted criteria." (a defined decide task with options in hand - go straight to `tfs-decision-option-review`)
- "Is this PRD any good? Critique it." (review of a finished artifact, not routing an unframed situation)
- "Facilitate our team offsite agenda." (group facilitation / human-social - a thin family; redirect, do not force a `tfs-` pick)
