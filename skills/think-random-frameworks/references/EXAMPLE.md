...
|---|---|---|---|
| 1 | think-iceberg-model | P | good (systemic, but not the obvious reach) |
| 2 | think-fermi-estimation | M/P | poor - flagged, applied anyway |
| 3 | think-backcasting | P | partial |

## Applied artifacts (abbreviated)

### 1. think-iceberg-model
