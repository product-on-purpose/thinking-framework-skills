...
- **Next tool (one-way doors only):** [the heavier tool the decision should now go to - e.g. `think-decision-option-review` to compare options, `think-premortem` to stress-test the commitment]
